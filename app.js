...
function sumArray(sumArr) { //eslint-disable-line
    ...
    var result5 = sum(sumArr[0],sumArr[1])[0];
    var result6 = sum(result5,sumArr[2])[0] ; 
    return [result6 , testArray +' was passed in as an array of numbers, and '+ result6 +' is their sum'+'.'];
}
...
function multiplyArray(multArr) { //eslint-disable-line
    ...
    var result7=multiply(multArr[0],multArr[1])[0];
    var result8=multiply(result7,multArr[2])[0];
     
 return[result8,'The numbers '+testArray+' have a product of '+result8+'.']
}
