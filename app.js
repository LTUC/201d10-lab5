...
multiply=1;
for (var index = 0; index < testArray.length; index++) {
    multiply=multiply*testArray[index];
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    multiply=1;
    for (var index = 0; index <  testDynamicArray.length; index++) {
        multiply=multiply* testDynamicArray[index];
        
    }
    return[multiply,'The numbers '+testDynamicArray+' have a product of '+multiply+'.']
    }
