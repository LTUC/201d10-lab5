...
JavaScript (JS)
 (Links to an external site.)HTML
...
p { font-size:20px; color:red; } . . .will create a 20 point font paragraph with red letters.
 ...
 (Links to an external site.)java script
...
Limitations of JavaScript We cannot treat JavaScript as a full-fledged programming language. It lacks the following important features −
